...
namespace ResultExporterApp
{
    ...
    {
        public Dictionary<string, string> CustomFileValues { get; }
        ...
        public bool Execute(string outputFolder)
        {
        ...
        public string GetNewFilePath(string outputFolder)
        {
            string newFileName = $"Flight analytics L{CustomFileValues["_RE_TITLE_"].Substring(1,2).Replace("-","")} - {DateTime.Today.ToString("dd.MM.yyyy.")}.html";
        ...
        public bool PrepareValues(int deviceId, int yMax, double ctrLng, double ctrLat, List<List<LogEntry>> logCollection, List<List<LogEntry>> breakCollection)
        {
            ...
            BreakCollection = breakCollection;

            if(LogCollection == null || BreakCollection == null || CustomFileValues.Any(v => v.Value == "" || v.Value == null) || LogCollection.Count == 0)
                throw new Exception("The map generation dictionary is corrupted.");
